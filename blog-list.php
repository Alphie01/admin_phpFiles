...
<!-- end page title -->
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                <div>
                                                            ...
                                                            <div>
                                                                <ul class="nav nav-pills justify-content-end">
                                                                    ...
                                                                    <li class="nav-item" data-bs-placement="top" title="List">
                                                                        <a class="nav-link active" href="blog-list.php">
                                                                            <i class="mdi mdi-format-list-bulleted"></i>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item" data-bs-placement="top" title="Grid">
                                                                        <a class="nav-link" href="blog-grid.php">
                                                    ...
                                                    <div>
                                                        <h5><a href="blog-details.php" class="text-dark">Beautiful Day with Friends</a></h5>
                                                    ...
                                                    <div>
                                                        <h5><a href="blog-details.php" class="text-dark">Project discussion with team</a></h5>
                                                        ...
                                                        <div class="position-relative mb-3">
                                                            ...
                                                            <div class="blog-play-icon">
                                                                <a href="#" class="avatar-sm d-block mx-auto">
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <div class="list-group list-group-flush">
                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Beautiful Day with Friends</a>

                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Drawing a sketch</a>

                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Project discussion with team</a>
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <div class="list-group list-group-flush">
                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Coffee with Friends</a>

                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Neque porro quisquam est</a>

                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Quis autem vel eum iure</a>

                                                        <a href="blog-details.php" class="list-group-item text-muted"><i class="mdi mdi-circle-medium me-1"></i> Cras mi eu turpis</a>
        ...
        <?php include './backends/footer.php' ?>   </div>
    <!-- end main content-->
