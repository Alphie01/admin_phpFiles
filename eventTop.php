    ...
    <div class="card">
        <div class="card-body">
            <div id="lnb">
                ...
                <input type="hidden" id="kull_yetki" value="<?= $kullanicicek['kullanici_yetki'] ?>">
                <input type="hidden" id="kull_id" value="<?= $kullanicicek['kullanici_id'] ?>">
...
<script src="assets/js/pages/subEvent.js"></script>
