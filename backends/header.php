<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <form class="app-search d-none d-lg-block">
                <div class="position-relative">
                    <input type="text" class="form-control" placeholder="Search..." onkeyup="showResult(this.value)" onblur="displayNoneSearch()" onfocus="displaySearch()">
                    <span class="bx bx-search-alt"></span>
                </div>
            </form>

            <div class="" id="livesearched" style="width: 30%; position:absolute; display:none; top:70px; left:250px; z-index:0;  background-color:white;">
        ...
        <script>
            var livesearched = document.getElementById('livesearched');
            ...
            function displayNoneSearch() {
                /* livesearched.style.display = 'none'; */
            }
            ...
            function showResult(str) {
                ...
                console.log(str);
                if (str.length == 0) {
                    livesearched.innerHTML = "";
                    livesearched.style.border = "0px";
                    return;
                }
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        livesearched.innerHTML = this.responseText;
                        livesearched.style.border = "0px";
                    }
                }
                livesearched.style.display = 'inline';
                xmlhttp.open("GET", "./backends/searchLive.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="assets/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <a href="" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="assets/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <a href="" class="dropdown-item notify-item language" data-lang="it">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mt-0 mb-1" key="t-your-order">Welcome Faith Project...</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1" key="t-grammer">We Are Happy To See You!</p>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-xl-inline-block ms-1" key="t-henry"><?= $kullanicicek['kullanici_adsoyad'] ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="contacts-profile.php?id=<?= $kullanicicek['kullanici_id'] ?>"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>


                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="./backends/logout.php"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Logout</span></a>
                </div>
            </div>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                ?>
                    ...
                    <li class="menu-title" key="t-menu">Page Control</li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="../index.php?duzenle=1" key="t-default">Edit Homepage</a></li>
                            <li><a href="../event6/about.php?duzenle=1" key="t-default">Edit About Us</a></li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="waves-effect has-arrow ">
                            ...
                            <i class="bx bx-briefcase-alt-2"></i>
                            <span key="t-dashboards">Same Variables</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="home_sliders.php" key="t-default">Homepage Sliders</a></li>
                            <li><a href="services.php" key="t-default">Services</a></li>
                            <li><a href="project-result.php" key="t-default">Project Results</a></li>
                            <li><a href="partners.php" key="t-default">Partners</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="projects-create.php?part=1" key="t-create-new">Create New</a></li>
                    </ul>
                </li>
                <?php
                if ($kullanicicek['kullanici_yetki'] > 1) {
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="blog-grid.php" key="t-blog-grid">Blog List</a></li>
                        <?php
                        if ($kullanicicek['kullanici_yetki'] > 1) {
                        ?>
                            <li><a href="blog-create.php" key="t-blog-details">Create New</a></li>
                        <?php } ?>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <span class="badge rounded-pill bg-success float-end" key="t-new">New</span>
                        <i class="bx bx-detail"></i>
                        <span key="t-blog">Events</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="events.php" key="t-blog-list">Events List</a></li>
                ...
                ?>
                    ...
                    <li class="menu-title" key="t-menu">Personal</li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                ...
                ?>
                    ...
                    <li class="menu-title" key="t-menu">Project Owners</li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bxs-user-detail"></i>
                            <span key="t-contacts">Contact</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">

                            <li><a href="contacts-list.php" key="t-user-list">Contacts</a></li>
                            <li><a href="contacts-grid.php" key="t-user-list">Users List</a></li>

                        </ul>
                    </li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <span class="badge rounded-pill bg-success float-end" key="t-new">Upcoming</span>
                            <i class="bx bx-envelope"></i>
                            <span key="t-email">Email</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="#" key="t-inbox">Inbox</a></li>
                            <li><a href="#" key="t-read-email">Read Email</a></li>
                ...
                ?>
                    ...
                    <li class="menu-title" key="t-menu">Dev</li>
