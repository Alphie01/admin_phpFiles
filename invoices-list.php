...
<html lang="tr">
    ...
    <head>
        ...
        <meta charset="utf-8" />
<title>Invoice List |Admin Panel</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14251</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14252</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14253</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14254</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14255</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14256</a>
                                                    <h5 class="text-truncate mb-4 mb-lg-5">Landing page Design</h5>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item me-3">
                                                            <h5 class="font-size-14" data-toggle="tooltip" data-placement="top" title="Amount"><i class="bx bx-money me-1 text-muted"></i> $ 1189</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="text-lg-center">
                                                    <img src="assets/images/users/avatar-1.jpg" class="avatar-sm me-3 mx-lg-auto mb-3 mt-1 float-start float-lg-none rounded-circle" alt="img" />
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14257</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14258</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div>
                                                    <a href="invoices-detail.php" class="d-block text-primary text-decoration-underline mb-2">Invoice #14259</a>
