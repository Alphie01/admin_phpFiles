                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form action="./backends/islem.php" method="POST">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="kullanici_mail" id="useremail" placeholder="Enter email">
                                            </div>

                                            <div class="text-end">
                                                <button name="resetPW" class="btn btn-primary w-md waves-effect waves-light" type="submit">Reset</button>
                                            </div>
