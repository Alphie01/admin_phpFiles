...
$slidersor = $db->prepare("SELECT * FROM services where services_id=:services_id ORDER BY services_id DESC");
$slidersor->execute(array(
    'services_id' => $_GET['serviceId']
));
                                            ...
                                            <div class="col-xl-8">
                                                <form action="./backends/islem.php" method="post" enctype="multipart/form-data">
                                                    <div>
                                                        ...
                                                        <textarea name="services_title" class="editor" id="" cols="30" rows="10"><?= $slidercek['services_title'] ?></textarea>
                                                        ...
                                                        <div class="mt-4">
                                                            <div class="text-muted font-size-14">
                                                                <textarea name="services_content" style="height:700px;" class="editor" id="" cols="30" rows="10">
                                                                <?= $slidercek['services_content'] ?></textarea>
                                                        ...
                                                        <input type="hidden" name="services_id" value="<?=$_GET['serviceId'] ?>">
