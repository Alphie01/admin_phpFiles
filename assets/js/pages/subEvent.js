...
(function (window, Calendar) {
  ...
  function saveToDataBase(e) {
    var elementCrator = document.getElementById("kull_id").value;
    console.log(
      "./backends/calenderIslem.php?calenderNewKayit=ok&calender_event_title=" +
        e.title +
        "&calender_event_body=" +
        e.body +
  ...
  function updateDataBase(e) {
    ...
    var body = e.schedule.body;
    var start = e.schedule.start._date;
    var end = e.schedule.end._date;
    var isAllDay = e.schedule.isAllDay;
    var location = e.schedule.location;
    var calendarId = e.schedule.calendarId;

    if (e.changes != null) {
      if (e.changes.title != null) {
        title = e.changes.title;
      }
      if (e.changes.body != null) {
        body = e.changes.body;
      }
      ...
      if (e.changes.isAllDay != null) {
        isAllDay = e.changes.isAllDay;
      }
      if (e.changes.location != null) {
        location = e.changes.location;
      }
      if (e.changes.calendarId != null) {
        calendarId = e.changes.calendarId;
      }
    }

    console.log(
      "./backends/calenderIslem.php?updateCalender=ok&calender_event_id=" +
        e.schedule.raw.memo +
